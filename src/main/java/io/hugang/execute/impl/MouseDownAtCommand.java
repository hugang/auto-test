...
@WebCommand
public class MouseDownAtCommand extends Command {
    public MouseDownAtCommand(String command, String target, String value) {
    ...
    public boolean _execute() {
        ...
        if (ObjectUtil.isNotEmpty(offSets) && offSets.length == 2) {
            ...
            actions.moveToElement($, x, y).clickAndHold().perform();
            return true;
        }
        return false;
    }
